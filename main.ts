...
const login = getS('.login')as HTMLInputElement;
const password = getS('.password') as HTMLInputElement;
const email = getS('.email')as HTMLInputElement;
